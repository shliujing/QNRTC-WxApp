export const HOST = 'https://practice.dandantuan.com';
...
export const API = {
    ...
    DDT_ROOM_TOKEN: (roomid, userid, appid) =>
        `${HOST}/demo/rtn/roomtoken.php?app=${appid || getAppId()}&room=${roomid}&user=${userid}`,
};
...
export const getToken = (appid, roomid, userid) => {
    return new Promise((resolve, reject) => {
        ...
        const requestURL = `${API.DDT_ROOM_TOKEN(roomid, userid, appid)}`;
        wx.request({
            url: requestURL,
            success: (res) => {
